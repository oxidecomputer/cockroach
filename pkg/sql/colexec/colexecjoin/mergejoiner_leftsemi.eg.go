...
func (o *mergeJoinLeftSemiOp) probeBodyLSelfalseRSeltrue() {
	lSel := o.proberState.lBatch.Selection()
	rSel := o.proberState.rBatch.Selection()
	for eqColIdx := 0; eqColIdx < len(o.left.eqCols); eqColIdx++ {
		leftColIdx := o.left.eqCols[eqColIdx]
...
func (o *mergeJoinLeftSemiOp) probeBodyLSelfalseRSelfalse() {
	lSel := o.proberState.lBatch.Selection()
	rSel := o.proberState.rBatch.Selection()
	for eqColIdx := 0; eqColIdx < len(o.left.eqCols); eqColIdx++ {
		leftColIdx := o.left.eqCols[eqColIdx]
...
// in the batch.
func (o *mergeJoinLeftSemiOp) probe() {
...
// exhausted.
func (o *mergeJoinLeftSemiOp) exhaustLeftSource() {
}
...
func (o *mergeJoinLeftSemiOp) numBuiltFromBatch(groups []group) (numBuilt int) {
...
func (o *mergeJoinLeftSemiOp) buildFromBatch() {
...
func (o *mergeJoinLeftSemiOp) transitionIntoBuildingFromBufferedGroup() {
...
// For a more detailed explanation and an example please refer to the comment at
// the top of mergejoiner.go.
func (o *mergeJoinLeftSemiOp) buildFromBufferedGroup() (bufferedGroupComplete bool) {
	bg := &o.bufferedGroup
