...
var _ colexecop.Operator = &mergeJoinLeftOuterOp{}
...
func (o *mergeJoinLeftOuterOp) buildLeftGroupsFromBatch(
...
// SIDE EFFECTS: writes into o.output.
func (o *mergeJoinLeftOuterOp) buildRightGroupsFromBatch(
...
func (o *mergeJoinLeftOuterOp) numBuiltFromBatch(groups []group) (numBuilt int) {
...
func (o *mergeJoinLeftOuterOp) buildFromBatch() {
...
func (o *mergeJoinLeftOuterOp) transitionIntoBuildingFromBufferedGroup() {
...
// For a more detailed explanation and an example please refer to the comment at
// the top of mergejoiner.go.
func (o *mergeJoinLeftOuterOp) buildFromBufferedGroup() (bufferedGroupComplete bool) {
	bg := &o.bufferedGroup
