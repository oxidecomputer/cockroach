...
func (o *mergeJoinLeftAntiOp) numBuiltFromBatch(groups []group) (numBuilt int) {
...
func (o *mergeJoinLeftAntiOp) buildFromBatch() {
...
func (o *mergeJoinLeftAntiOp) transitionIntoBuildingFromBufferedGroup() {
...
// For a more detailed explanation and an example please refer to the comment at
// the top of mergejoiner.go.
func (o *mergeJoinLeftAntiOp) buildFromBufferedGroup() (bufferedGroupComplete bool) {
	bg := &o.bufferedGroup
