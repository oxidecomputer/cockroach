...
var _ colexecop.Operator = &mergeJoinRightOuterOp{}
...
func (o *mergeJoinRightOuterOp) buildLeftGroupsFromBatch(
...
// SIDE EFFECTS: writes into o.output.
func (o *mergeJoinRightOuterOp) buildRightGroupsFromBatch(
...
func (o *mergeJoinRightOuterOp) numBuiltFromBatch(groups []group) (numBuilt int) {
...
func (o *mergeJoinRightOuterOp) buildFromBatch() {
...
func (o *mergeJoinRightOuterOp) transitionIntoBuildingFromBufferedGroup() {
...
// For a more detailed explanation and an example please refer to the comment at
// the top of mergejoiner.go.
func (o *mergeJoinRightOuterOp) buildFromBufferedGroup() (bufferedGroupComplete bool) {
	bg := &o.bufferedGroup
